    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female')], max_length=1)),
                ('phone_number', models.CharField(max_length=15)),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HealthOnline.room')),
                ('specialization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HealthOnline.specialization')),
            ],
        ),
        migrations.AddField(
